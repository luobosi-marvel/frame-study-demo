 ...
 * @since 2018-12-11
 */
public class JedisServer extends Jedis {
    ...
    public Long zadd(final String key, final double score, final String member) {
        try {
            return redis.zadd(key, new IRedisSortedSet.ZsetPair(member, score));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Long zadd(String key, double score, String member, ZAddParams params) {
        ...
        try {
            ...
            if(params.contains("xx")) {
                ...
                redis.zadd(key, new IRedisSortedSet.ZsetPair(member, score));
                return 1L;
            }else {
                return redis.zadd(key, new IRedisSortedSet.ZsetPair(member, score));
            }
    ...
    public Long zadd(final String key, final Map<String, Double> scoreMembers) {
        try {
            Double score = null;
            String member = null;
            List<IRedisSortedSet.ZsetPair> scoresmembers = new ArrayList<IRedisSortedSet.ZsetPair>((scoreMembers.size() - 1) * 2);
            ...
            return redis.zadd(key, new IRedisSortedSet.ZsetPair(member, score), (IRedisSortedSet.ZsetPair[]) scoresmembers.toArray());
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrange(final String key, final long start, final long end) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrange(key, start, end));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrevrange(final String key, final long start, final long end) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrevrange(key, start, end));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrangeByScore(final String key, final double min, final double max) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrangebyscore(key, String.valueOf(min), String.valueOf(max)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrangeByScore(final String key, final String min, final String max) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrangebyscore(key, min, max));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrangeByScore(final String key, final double min, final double max, final int offset, final int count) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrangebyscore(key, String.valueOf(min), String.valueOf(max), "limit", String.valueOf(offset),
    ...
    public Set<String> zrangeByScore(final String key, final String min, final String max, final int offset, final int count) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrangebyscore(key, min, max, "limit", String.valueOf(offset), String.valueOf(count)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrevrangeByScore(final String key, final double max, final double min) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrevrangebyscore(key, String.valueOf(max), String.valueOf(min)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrevrangeByScore(final String key, final String max, final String min) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrevrangebyscore(key, max, min));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public Set<String> zrevrangeByScore(final String key, final double max, final double min, final int offset, final int count) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrevrangebyscore(key, String.valueOf(max), String.valueOf(min), "limit", String.valueOf(offset),
                    String.valueOf(count)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    ...
    public Set<String> zrevrangeByScore(final String key, final String max, final String min, final int offset, final int count) {
        try {
            return IRedisSortedSet.ZsetPair.members(redis.zrevrangebyscore(key, max, min, "limit", String.valueOf(offset), String.valueOf(count)));
        } catch (Exception e) {
            throw new JedisException(e);
        }
    }
    ...
    public ScanResult<Map.Entry<String, String>> hscan(final String key, final String cursor) {
        try {
            ...
            List<Map.Entry<String, String>> list = results.entrySet().stream().collect(Collectors.toList());
            ScanResult<Map.Entry<String, String>> result = new ScanResult<Map.Entry<String, String>>("0", list);
    ...
    public ScanResult<Tuple> zscan(final String key, final String cursor) {
        try {
            org.rarefiedredis.redis.ScanResult<Set<IRedisSortedSet.ZsetPair>> sr = redis.zscan(key, Long.valueOf(cursor), "count", "1000000");
            List<IRedisSortedSet.ZsetPair> list = sr.results.stream().collect(Collectors.toList());
